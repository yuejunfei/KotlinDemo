package com.example.ktdemo.weight;
...
import com.example.ktdemo.adapter.BannerViewAdapter;
...
public class BannerView extends RelativeLayout {
    ...
    private void init() {
        ...
        LinearLayout.LayoutParams vp_param = new LinearLayout.LayoutParams(LinearLayout
